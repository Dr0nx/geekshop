...
from admins.views import index, admin_users, admin_users_create, admin_users_update, admin_users_delete, \
    admin_category, admin_category_create, admin_category_update, admin_category_delete, admin_product, \
    admin_product_create, admin_product_delete, admin_product_update
