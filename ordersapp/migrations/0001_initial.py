# Generated by Django 3.2.9 on 2021-12-26 12:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PD', 'оплачено'), ('PRD', 'обрабатывается'), ('RDY', 'готов в выдаче'), ('CNC', 'отмена заказа')], default='FM', max_length=3, verbose_name='статус')),
